...
class Ui_about_dialog(object):
    def setupUi(self, about_dialog):
        ...
        about_dialog.setMinimumSize(QtCore.QSize(490, 355))
        about_dialog.setMaximumSize(QtCore.QSize(490, 355))
        icon = QtGui.QIcon()
        ...
        self.image_button = QtWidgets.QPushButton(about_dialog)
        self.image_button.setEnabled(False)
        self.image_button.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images/image (2).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/images/images/image (2).png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        self.image_button.setIcon(icon1)
        self.image_button.setIconSize(QtCore.QSize(153, 329))
        self.image_button.setAutoDefault(False)
    ...
    def retranslateUi(self, about_dialog):
        ...
        self.label_2.setText(_translate("about_dialog", "clb_autocalibration - программа для автоматической калибровки калибратора тока и напряжения N4-25\n"
"\n"
"Копирайт© 2000-2020 ООО \"РЭС\"\n"
"\n"
""))
