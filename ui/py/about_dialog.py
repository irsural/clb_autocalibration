...
class Ui_about_dialog(object):
    def setupUi(self, about_dialog):
        ...
        self.copyright_year_label = QtWidgets.QLabel(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.copyright_year_label.sizePolicy().hasHeightForWidth())
        self.copyright_year_label.setSizePolicy(sizePolicy)
        self.copyright_year_label.setText("")
        self.copyright_year_label.setObjectName("copyright_year_label")
        self.horizontalLayout_3.addWidget(self.copyright_year_label)
    ...
    def retranslateUi(self, about_dialog):
        ...
        self.label_5.setText(_translate("about_dialog", "Копирайт© 2000-"))
        self.label_4.setText(_translate("about_dialog", " ООО \"РЭС\""))
