...
class Ui_correction_tables_dialog(object):
    def setupUi(self, correction_tables_dialog):
        ...
        self.widget = QtWidgets.QWidget(self.correction_tables_splitter)
        self.widget.setObjectName("widget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.table_names_list = QtWidgets.QListWidget(self.widget)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.save_to_file_button = QtWidgets.QPushButton(self.widget)
