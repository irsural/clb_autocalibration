...
class Ui_edit_cell_config_dialog(object):
    def setupUi(self, edit_cell_config_dialog):
        ...
        self.measure_time_spinbox.setMinimum(1)
...
"selection-background-color: rgb(170, 170, 255);")
        ...
        edit_cell_config_dialog.setTabOrder(self.extra_variables_table, self.add_extra_param_button)
        edit_cell_config_dialog.setTabOrder(self.add_extra_param_button, self.remove_extra_param_button)
    ...
    def retranslateUi(self, edit_cell_config_dialog):
        ...
        item.setText(_translate("edit_cell_config_dialog", "Инд. бита"))
        ...
        item.setText(_translate("edit_cell_config_dialog", "Рабоч. знач."))
        item = self.extra_variables_table.horizontalHeaderItem(5)
        item.setText(_translate("edit_cell_config_dialog", "Знач. по-умолч."))
