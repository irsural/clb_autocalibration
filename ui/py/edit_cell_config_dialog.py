...
class Ui_edit_cell_config_dialog(object):
    def setupUi(self, edit_cell_config_dialog):
        ...
        edit_cell_config_dialog.resize(423, 602)
        font = QtGui.QFont()
        ...
        self.gridLayout.addWidget(self.manual_range_checkbox, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.manual_range_spinbox, 5, 1, 1, 1)
...
"selection-background-color: rgb(170, 170, 255);")
    ...
    def retranslateUi(self, edit_cell_config_dialog):
        ...
        self.manual_range_checkbox.setText(_translate("edit_cell_config_dialog", "Ручной диапазон измерителя"))
