...
class Ui_edit_cell_config_dialog(object):
    def setupUi(self, edit_cell_config_dialog):
        ...
        edit_cell_config_dialog.resize(457, 602)
        font = QtGui.QFont()
        ...
        self.gridLayout.addWidget(self.measure_time_spinbox, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.retry_count_spinbox, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.measure_delay_spinbox, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.coefficient_edit, 4, 2, 1, 1)
        self.manual_range_spinbox = QtWidgets.QDoubleSpinBox(edit_cell_config_dialog)
        self.manual_range_spinbox.setEnabled(False)
        self.manual_range_spinbox.setDecimals(8)
        self.manual_range_spinbox.setMinimum(1e-06)
        self.manual_range_spinbox.setMaximum(1000.0)
        self.manual_range_spinbox.setSingleStep(0.01)
        self.manual_range_spinbox.setProperty("value", 1.0)
        self.manual_range_spinbox.setObjectName("manual_range_spinbox")
        self.gridLayout.addWidget(self.manual_range_spinbox, 5, 2, 1, 1)
        self.label_4 = QtWidgets.QLabel(edit_cell_config_dialog)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 1, 0, 1, 1)
        self.auto_coefficient_checkbox = QtWidgets.QCheckBox(edit_cell_config_dialog)
        self.auto_coefficient_checkbox.setObjectName("auto_coefficient_checkbox")
        self.gridLayout.addWidget(self.auto_coefficient_checkbox, 4, 1, 1, 1)
        self.manual_range_checkbox = QtWidgets.QCheckBox(edit_cell_config_dialog)
        self.manual_range_checkbox.setObjectName("manual_range_checkbox")
        self.gridLayout.addWidget(self.manual_range_checkbox, 5, 1, 1, 1)
        self.label_8 = QtWidgets.QLabel(edit_cell_config_dialog)
...
"selection-background-color: rgb(170, 170, 255);")
        ...
        edit_cell_config_dialog.setTabOrder(self.divider_650_radio, self.divider_350_radio)
        edit_cell_config_dialog.setTabOrder(self.divider_350_radio, self.divider_55_radio)
        edit_cell_config_dialog.setTabOrder(self.divider_55_radio, self.ammeter_radio)
    ...
    def retranslateUi(self, edit_cell_config_dialog):
        ...
        self.auto_coefficient_checkbox.setText(_translate("edit_cell_config_dialog", "Авто"))
        self.manual_range_checkbox.setText(_translate("edit_cell_config_dialog", "Вкл"))
        self.label_8.setText(_translate("edit_cell_config_dialog", "Ручной диапазон измерителя"))
