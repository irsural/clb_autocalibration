...
class Ui_edit_cell_config_dialog(object):
    def setupUi(self, edit_cell_config_dialog):
        ...
        self.consider_output_value_checkbox = QtWidgets.QCheckBox(edit_cell_config_dialog)
        self.consider_output_value_checkbox.setObjectName("consider_output_value_checkbox")
        self.gridLayout_2.addWidget(self.consider_output_value_checkbox, 5, 0, 1, 3)
...
"selection-background-color: rgb(170, 170, 255);")
        ...
        edit_cell_config_dialog.setTabOrder(self.measure_time_spinbox, self.auto_coefficient_checkbox)
        edit_cell_config_dialog.setTabOrder(self.auto_coefficient_checkbox, self.coefficient_edit)
        edit_cell_config_dialog.setTabOrder(self.coefficient_edit, self.meter_config_edit)
        edit_cell_config_dialog.setTabOrder(self.meter_config_edit, self.consider_output_value_checkbox)
        edit_cell_config_dialog.setTabOrder(self.consider_output_value_checkbox, self.tabWidget)
        ...
        edit_cell_config_dialog.setTabOrder(self.voltmeter_radio, self.accept_button)
        edit_cell_config_dialog.setTabOrder(self.accept_button, self.cancel_button)
        edit_cell_config_dialog.setTabOrder(self.cancel_button, self.extra_variables_table)
        edit_cell_config_dialog.setTabOrder(self.extra_variables_table, self.remove_extra_param_button)
        edit_cell_config_dialog.setTabOrder(self.remove_extra_param_button, self.add_extra_param_button)
    ...
    def retranslateUi(self, edit_cell_config_dialog):
        ...
        self.consider_output_value_checkbox.setText(_translate("edit_cell_config_dialog", "Учитывать выходное значение при измерении"))
        ...
        self.label_3.setText(_translate("edit_cell_config_dialog", "Настройки измерителя"))
...
"по-умолчанию"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("edit_cell_config_dialog", "Сетевые перем."))
