...
"selection-background-color: rgb(170, 170, 255);")
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/icons/add_file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.new_configuration_action.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/icons/tracker.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.switch_to_active_cell_action.setIcon(icon24)
