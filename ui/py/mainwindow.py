...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.meter_combobox.addItem("")
        self.gridLayout_2.addWidget(self.meter_combobox, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.meter_settings_button, 2, 2, 1, 1)
        ...
        self.scheme_combobox = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.scheme_combobox.setObjectName("scheme_combobox")
        self.scheme_combobox.addItem("")
        self.scheme_combobox.addItem("")
        self.gridLayout_2.addWidget(self.scheme_combobox, 1, 1, 1, 2)
        ...
        self.add_measure_button.setIconSize(QtCore.QSize(25, 25))
        ...
        self.delete_measure_button.setIconSize(QtCore.QSize(25, 25))
        ...
        self.rename_measure_button.setIconSize(QtCore.QSize(25, 25))
        ...
        self.open_shared_measure_parameters_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.open_shared_measure_parameters_button.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_shared_measure_parameters_button.setIcon(icon4)
        self.open_shared_measure_parameters_button.setIconSize(QtCore.QSize(25, 25))
        self.open_shared_measure_parameters_button.setObjectName("open_shared_measure_parameters_button")
        self.horizontalLayout_2.addWidget(self.open_shared_measure_parameters_button)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.update_measure_status_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.update_measure_status_button.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/eye_checked.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.update_measure_status_button.setIcon(icon5)
        self.update_measure_status_button.setIconSize(QtCore.QSize(25, 25))
        self.update_measure_status_button.setObjectName("update_measure_status_button")
        self.horizontalLayout_2.addWidget(self.update_measure_status_button)
        self.enable_all_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.enable_all_button.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/checkboxes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.enable_all_button.setIcon(icon6)
        self.enable_all_button.setIconSize(QtCore.QSize(25, 25))
        ...
        self.measures_table.setColumnCount(4)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.measures_table.setHorizontalHeaderItem(3, item)
        self.measures_table.horizontalHeader().setStretchLastSection(False)
        self.measures_table.verticalHeader().setVisible(True)
        ...
        self.verticalLayout_2.setContentsMargins(7, 0, 7, 1)
        self.verticalLayout_2.setSpacing(2)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setContentsMargins(-1, 4, -1, 2)
        self.horizontalLayout_3.setSpacing(6)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.save_current_measure_button = QtWidgets.QPushButton(self.groupBox)
        self.save_current_measure_button.setMinimumSize(QtCore.QSize(30, 30))
        self.save_current_measure_button.setMaximumSize(QtCore.QSize(30, 30))
        ...
        self.save_current_measure_button.setIcon(icon7)
        self.save_current_measure_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.open_cell_config_button.setMinimumSize(QtCore.QSize(30, 30))
        self.open_cell_config_button.setMaximumSize(QtCore.QSize(30, 30))
        self.open_cell_config_button.setText("")
        self.open_cell_config_button.setIcon(icon4)
        self.open_cell_config_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.start_current_measure_button.setMinimumSize(QtCore.QSize(30, 30))
        self.start_current_measure_button.setMaximumSize(QtCore.QSize(30, 30))
        self.start_current_measure_button.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.start_current_measure_button.setIcon(icon8)
        self.start_current_measure_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.continue_current_measure_button.setMinimumSize(QtCore.QSize(30, 30))
        self.continue_current_measure_button.setMaximumSize(QtCore.QSize(30, 30))
        self.continue_current_measure_button.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.continue_current_measure_button.setIcon(icon9)
        self.continue_current_measure_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.add_row_button.setMinimumSize(QtCore.QSize(30, 30))
        self.add_row_button.setMaximumSize(QtCore.QSize(30, 30))
        self.add_row_button.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/add_row.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_row_button.setIcon(icon10)
        self.add_row_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.remove_row_button.setMinimumSize(QtCore.QSize(30, 30))
        self.remove_row_button.setMaximumSize(QtCore.QSize(30, 30))
        self.remove_row_button.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/icons/remove_row.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remove_row_button.setIcon(icon11)
        self.remove_row_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.add_column_button.setMinimumSize(QtCore.QSize(30, 30))
        self.add_column_button.setMaximumSize(QtCore.QSize(30, 30))
        self.add_column_button.setText("")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/icons/add_col.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_column_button.setIcon(icon12)
        self.add_column_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.remove_column_button.setMinimumSize(QtCore.QSize(30, 30))
        self.remove_column_button.setMaximumSize(QtCore.QSize(30, 30))
        self.remove_column_button.setText("")
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/icons/remove_col.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remove_column_button.setIcon(icon13)
        self.remove_column_button.setIconSize(QtCore.QSize(23, 23))
        ...
        self.clear_table_button = QtWidgets.QPushButton(self.groupBox)
        self.clear_table_button.setMinimumSize(QtCore.QSize(30, 30))
        self.clear_table_button.setMaximumSize(QtCore.QSize(30, 30))
        self.clear_table_button.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/icons/clear_table.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clear_table_button.setIcon(icon14)
        self.clear_table_button.setIconSize(QtCore.QSize(23, 23))
        self.clear_table_button.setObjectName("clear_table_button")
        self.horizontalLayout_3.addWidget(self.clear_table_button)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.displayed_data_type_combobox.sizePolicy().hasHeightForWidth())
        self.displayed_data_type_combobox.setSizePolicy(sizePolicy)
        ...
        self.update_calculated_cells_data_button = QtWidgets.QPushButton(self.groupBox)
        self.update_calculated_cells_data_button.setMinimumSize(QtCore.QSize(30, 30))
        self.update_calculated_cells_data_button.setMaximumSize(QtCore.QSize(30, 30))
        self.update_calculated_cells_data_button.setText("")
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/icons/update.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.update_calculated_cells_data_button.setIcon(icon15)
        self.update_calculated_cells_data_button.setIconSize(QtCore.QSize(20, 20))
        self.update_calculated_cells_data_button.setObjectName("update_calculated_cells_data_button")
        self.horizontalLayout_3.addWidget(self.update_calculated_cells_data_button)
...
"selection-background-color: rgb(170, 170, 255);")
        ...
        font = QtGui.QFont()
        font.setPointSize(8)
        self.open_about_action.setFont(font)
        self.open_about_action.setObjectName("open_about_action")
        self.open_tstlan_action = QtWidgets.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/icons/tstlan.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_tstlan_action.setIcon(icon16)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.save_action.setIcon(icon7)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/icons/open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_action.setIcon(icon17)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/icons/save_as.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.save_as_action.setIcon(icon18)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.start_all_action.setIcon(icon8)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.continue_all_action.setIcon(icon9)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/icons/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stop_all_action.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/icons/correction.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.correction_action.setIcon(icon20)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/icons/memory.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.flash_all_action.setIcon(icon21)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.verify_all_action.setIcon(icon5)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/icons/graph_2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.graphs_action.setIcon(icon22)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/icons/lock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lock_action.setIcon(icon23)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/icons/unlock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.unlock_action.setIcon(icon24)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/icons/squares.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_equal_action.setIcon(icon25)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.show_cell_graph_action.setIcon(icon22)
        ...
        self.flash_current_measure_action.setIcon(icon21)
        ...
        self.flash_diapason_of_cell_action.setIcon(icon21)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/icons/icons/add_file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.new_configuration_action.setIcon(icon26)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icons/icons/tracker.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.switch_to_active_cell_action.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icons/icons/multi_lock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lock_all_action.setIcon(icon28)
        self.lock_all_action.setObjectName("lock_all_action")
        self.unlock_all_action = QtWidgets.QAction(MainWindow)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icons/icons/multi_unlock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.unlock_all_action.setIcon(icon29)
        self.unlock_all_action.setObjectName("unlock_all_action")
        self.stop_flash_verify_action = QtWidgets.QAction(MainWindow)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icons/icons/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stop_flash_verify_action.setIcon(icon30)
        ...
        self.verify_current_measure_action.setIcon(icon5)
        ...
        self.verify_diapason_of_cell_action.setIcon(icon5)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/icons/table_check.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.read_correction_tables_action.setIcon(icon31)
        ...
        self.show_scheme_in_cell_action = QtWidgets.QAction(MainWindow)
        self.show_scheme_in_cell_action.setCheckable(True)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icons/icons/scheme.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_scheme_in_cell_action.setIcon(icon32)
        self.show_scheme_in_cell_action.setObjectName("show_scheme_in_cell_action")
        self.calculate_divider_coefficients = QtWidgets.QAction(MainWindow)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.calculate_divider_coefficients.setFont(font)
        self.calculate_divider_coefficients.setObjectName("calculate_divider_coefficients")
        ...
        self.menu_4.addAction(self.calculate_divider_coefficients)
        ...
        self.toolBar.addAction(self.show_scheme_in_cell_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.meter_combobox.setItemText(1, _translate("MainWindow", "Рандом генератор ±2%"))
        ...
        self.update_measure_status_button.setToolTip(_translate("MainWindow", "Проверить отклонение и болтанку"))
        ...
        item.setText(_translate("MainWindow", "Стат."))
        item = self.measures_table.horizontalHeaderItem(3)
        ...
        self.menu_4.setTitle(_translate("MainWindow", "Дополнительно"))
