...
"selection-background-color: rgb(170, 170, 255);")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/icons/eye_checked.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/icons/squares.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_equal_action.setIcon(icon18)
        font = QtGui.QFont()
        font.setPointSize(10)
