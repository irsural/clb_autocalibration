...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_2.setContentsMargins(7, 11, 7, 7)
...
"selection-background-color: rgb(170, 170, 255);")
        ...
        self.curent_cell_progress_bar = QtWidgets.QProgressBar(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        ...
        self.horizontalLayout.addWidget(self.curent_cell_progress_bar)
        self.measure_progress_bar = QtWidgets.QProgressBar(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        ...
        self.horizontalLayout.addWidget(self.measure_progress_bar)
        ...
        self.verify_action.setIcon(icon19)
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.new_configuration_action.setText(_translate("MainWindow", "new_configuration"))
