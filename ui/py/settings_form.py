...
class Ui_settings_dialog(object):
    def setupUi(self, settings_dialog):
        ...
        settings_dialog.resize(672, 526)
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(settings_dialog)
...
"}")
    ...
    def retranslateUi(self, settings_dialog):
        ...
        item.setText(_translate("settings_dialog", "Параметры шага"))
        self.settings_menu_list.setSortingEnabled(__sortingEnabled)
        self.fixed_range_groupbox.setTitle(_translate("settings_dialog", "Фиксированный шаг"))
        self.verticalGroupBox_2.setWhatsThis(_translate("settings_dialog", "Относительный шаг устанавливается в процентах от максимума шкалы поверяемого прибора"))
        self.verticalGroupBox_2.setTitle(_translate("settings_dialog", "Относительный шаг"))
        self.label.setText(_translate("settings_dialog", "Точный, %"))
        self.label_2.setText(_translate("settings_dialog", "Обычный, %"))
        self.label_3.setText(_translate("settings_dialog", "Грубый, %"))
